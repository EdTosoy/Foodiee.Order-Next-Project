...
export default function App() {
  return (
    <section className="grid-container pt-28 pb-10" id="Get-App" >
      <main className="col-start-2 col-end-3 flex flex-col-reverse md:flex-row-reverse justify-between items-center text-white p-10 rounded-2xl bg-brown">
        <div className="text-center md:text-left max-w-md mt-10">
          ...
          <button
            className="w-20 m-4 -mt-4 md:m-0 md:w-36 md:mr-8 rounded-full transform   hover:scale-105"
            aria-label="download"
          >
            <Image
          ...
          <button
            className="w-20 m-4 md:w-36 md:mr-8 rounded-full transform   hover:scale-105"
            aria-label="download"
          >
            <Image
