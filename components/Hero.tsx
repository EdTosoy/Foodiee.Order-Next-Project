    ...
    <section className="grid-container pt-20 pb-10">
      <main className="col-start-2 col-end-3 flex flex-col-reverse md:flex-row justify-between items-center">
        <div className="text-center md:text-left max-w-md">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-10 mb-2 md:mb-5 text-brown">
            Enjoy Our
          </h1>
          <h1 className="text-4xl md:text-6xl font-bold leading-10 mb-7 text-brown">
            Majestic Meals
          </h1>
          <p className="text-sm mb-7 text-brown font-light">
        ...
        <div className="">
          <Image src="/images/hero-img.png" width={560} height={530} />
        </div>
      </main>
    </section>
  );
